		...
		<div className={style.docbox}>
			<div className={style.docboxContent}>
				...
				<div className={` ${protoStyle.displayFlex} ${protoStyle.colsGutterXsm} ${protoStyle.marginTopXsm} ${protoStyle.marginBottomLg}`}>
					<div className={protoStyle.flexWidth50per}><Progress value={45} color="info" /></div>
				</div>
				<h3 className={style.docHeading3}>Warning</h3>
				<div className={` ${protoStyle.displayFlex} ${protoStyle.colsGutterXsm} ${protoStyle.marginTopXsm} ${protoStyle.marginBottomLg}`}>
					<div className={protoStyle.flexWidth50per}><Progress value={60} color="warning" /></div>
				</div>
				<h3 className={style.docHeading3}>Success</h3>
				<div className={` ${protoStyle.displayFlex} ${protoStyle.colsGutterXsm} ${protoStyle.marginTopXsm} ${protoStyle.marginBottomLg}`}>
					<div className={protoStyle.flexWidth50per}><Progress value={15} color="success" /></div>
				</div>
				<h3 className={style.docHeading3}>Error</h3>
				<div className={` ${protoStyle.displayFlex} ${protoStyle.colsGutterXsm} ${protoStyle.marginTopXsm} ${protoStyle.marginBottomLg}`}>
					<div className={protoStyle.flexWidth50per}><Progress value={70} color="error" /></div>
				</div>
			</div>
